...
| Q2 Data 🆕 | *Check our own position: inventory, customer commitments and what's already in SAP.* | Dahej inventory, must-supply customers + compensation, SAP open POs + budget, lead time, delegation of authority | — | Contracting deadline per month, whether tanks can absorb a missed month, what SAP already covers, budget, approver |
...
| Q4 Analysis | *How did we get here? Show me the last 5 years.* | — | 5-year weekly history | The 2022 spike, today's spike, the spread, the volatility |
